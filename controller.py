...
class shortest_path(app_manager.RyuApp):
    ...
    # Main_dispatcher is reply packet from switch during handshak. This is keeping track of all switches in network
    # Deaddispatcher is packet from switch when it leaves the network
